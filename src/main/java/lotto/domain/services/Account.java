...
public class Account {
    ...
    public void profitAccount(Map<LottoEnum.grade, Integer> gradeMap, int ammount){
        double prize =
                (double) (gradeMap.get(LottoEnum.grade.FIFTH) * 5000 +
        ...
        double profitRate = prize*100/(double)ammount;
